            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <a class="btn-solid-lg page-scroll" href="inscription.php">SIMULER VOTRE PRET</a>
                    ...
                    <ul class="list-unstyled li-space-lg first">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Utilisé pour divers besoins comme l'achat d'équipement, les réparations de maison, les frais de santé ou les voyages.</p>
                            </div>
                        </li>
                        <li class="media">
                            <i class="bullet">2</i>
                            <div class="media-body">
                                <h4>Prêt auto</h4>
                                <p>Destiné spécifiquement à l'achat d'un véhicule avec un taux d'intérêt souvent plus bas que pour les prêts personnels. </p>
                            </div>
                        </li>
                    </ul>
                </div> <!-- end of col -->
                    ...
                    <ul class="list-unstyled li-space-lg second">
                        <li class="media">
                            ...
                            <div class="media-body">
                                ...
                                <p>Utilisé pour l'achat d'un bien immobilier ou pour financier des travaux de grande ampleur.</p>
                            </div>
                        </li>
                        <li class="media">
                            <i class="bullet">4</i>
                            <div class="media-body">
                                ...
                                <p>Une réserve de crédit qui se renouvelle au fur et à mesure que l'emprunteur rembourse.</p>
                            </div>
                        </li>
                    </ul>
                </div> <!-- end of col -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Taux compétitifs</h4>
                            <p>Comprendre où votre vite Web est actuellement positionné dans les requête des moteurs de recherche</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Réponse rapide en 24h</h4>
                            <p>Trouvez les meilleurs éléments pertinents qui correspondent à la stratégie de référencement de votre site web à long terme</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Démarches simplifiés et 100% en ligne</h4>
                            <p>Comment planifier votre stratégie de contenu et rédiger des articles optimisés pour le référencement</p>
                        </div>
                    </div>
                    <!-- end of card -->
