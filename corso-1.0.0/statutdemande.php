...
<head>
    ...
    <!-- Website Title -->
    <title>Statut de ma demande</title>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <header id="header" class="ex-header">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="white">Statut de ma demande d'emprunt</h1>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
                ...
                <div class="col-lg-12">
                    <div class="text-container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card-text">
                                    <h1>Statut de demande</h1>
                                    <p>Mrs demandeur votre demande de 1000€ est toujours en cours. Veillez revenis dans quelques instant pour voir votre demande. </p>
                                </div>
                            </div> <!-- end of col -->
                        </div> <!-- end of row -->
