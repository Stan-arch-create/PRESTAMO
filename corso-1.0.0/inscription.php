        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <form method="post">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                        <input type="text" class="form-control col-md-12" style="height:40px;" name="nom" placeholder="Nom" id="inputEmail3">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <div class="col-sm-10">
                        <button type="submit" name="envoyer" class="btn btn-outline-success col-md-12">S'inscrire</button>
                        </div>
                    </div>
                    <p>Vous avez un compte! <a href="connexion.php" style="color: blue;">Se connecter</a></p>
                </form>
